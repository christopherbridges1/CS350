...
while repeat:
    try:
        #increments duty cycle by 5 from 0 to 100
        for dutyCycle in range (0, 100, 5):
            pwm18.ChangeDutyCycle(dutyCycle)
            time.sleep(0.1)
            #Print statement for debugging and visual aid
            #print(f'Dimming to {dutyCycle}%')

        #decrements duty cycle by 5 from 0 to 100
